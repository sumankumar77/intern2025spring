...
from .models import Message, SystemEmailBackUp
...
class SystemEmailBackUpAdmin(admin.ModelAdmin):
    model = SystemEmailBackUp
    list_display = ['recipient', 'subject', 'sent_at']


admin.site.register(Message, MessageAdmin)
admin.site.register(SystemEmailBackUp, SystemEmailBackUpAdmin)
